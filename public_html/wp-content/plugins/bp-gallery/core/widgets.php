...
class BP_Gallery_Sitewide_Gallery_Widget extends WP_Widget{
	...
	function form( $instance ) {
	    ...
	    $type= $instance['type'];
        ?>
		<p><label for="bpgallery-widget-sitewide-galleries-title"><?php _e('Title:', 'bp-gallery'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( stripslashes( $title ) ); ?>" /></label></p>
			<p>
				<label for="bpgallery-widget-sitewide-galleries-count"><?php _e( 'How Many Galleries' , 'bp-gallery'); ?>
					<input type="text" id="<?php echo $this->get_field_id( 'count' ); ?>" name="<?php echo $this->get_field_name( 'count' ); ?>" class="widefat" value="<?php echo esc_attr( absint( $count ) ); ?>" />
				</label>
			</p>
                        <p>
...
class BP_Gallery_Sitewide_Media_Widget extends WP_Widget{
	...
	function form( $instance ) {
		...
		$show_thumb =  $instance['show_thumb'] ;
	?>
		<p><label for="bpgallery-widget-sitewide-medias-title"><?php _e('Title:', 'bp-gallery'); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( stripslashes( $title ) ); ?>" /></label></p>
			<p>
